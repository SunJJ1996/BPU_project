...
def YOLO_BPU_Processing_Judgment(video_path, Judgement_thresh):
    ...
    configPath = "/data/sunjunjiao/yolo_darknet/darknet/cfg/yolov4-BPU200706.cfg"
    weightPath = "/data/sunjunjiao/yolo_darknet/darknet/backup/BPU200706/yolov4-BPU200706_best.weights"
    metaPath = "/data/sunjunjiao/yolo_darknet/darknet/data/BPU200706.data"
